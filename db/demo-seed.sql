...
insert into tmp_demo_record_keys values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Deloitte', 'Business Analytics and ESG', '2024-02-12', 24, true, 1, 4, 0, 10, 2, 640000, 1, 700000, 200000, 0, 0, 9, 16, 7, 2, 2, 2, 1, 3, 3, 2, 1),
...
insert into tmp_demo_consultancy_rows values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Deloitte', 'Business Analytics and ESG', '2024-02-12', 'ESG reporting dashboard blueprint', 290000),
  ('BLR', 'LMS-BLR', 'MBA', 'Deloitte', 'Business Analytics and ESG', '2024-02-12', 'Business intelligence capstone mentoring', 350000),
...
insert into tmp_demo_grant_rows values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Deloitte', 'Business Analytics and ESG', '2024-02-12', 'ESG analytics for responsible campuses', 'Deloitte Impact Fund', 700000),
...
join (
  values
    ...
    ('BLR', 'Leadership and Management Studies', 'LMS-BLR'),
...
insert into tmp_demo_record_keys_extra values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Capgemini', 'Enterprise Transformation and ESG Strategy', '2023-11-17', 24, true, 2, 4, 0, 11, 2, 820000, 1, 960000, 280000, 1, 0, 10, 18, 7, 2, 2, 2, 1, 3, 3, 3, 1),
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Accenture', 'Digital Business Transformation', '2025-01-10', 24, true, 2, 3, 0, 12, 2, 910000, 1, 1050000, 320000, 0, 1, 11, 21, 9, 2, 2, 3, 1, 3, 4, 3, 1),
...
insert into tmp_demo_consultancy_rows_extra values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Capgemini', 'Enterprise Transformation and ESG Strategy', '2023-11-17', 'Transformation operating model review', 410000),
  ('BLR', 'LMS-BLR', 'MBA', 'Capgemini', 'Enterprise Transformation and ESG Strategy', '2023-11-17', 'ESG analytics capability roadmap', 410000),
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Accenture', 'Digital Business Transformation', '2025-01-10', 'Digital operating model benchmark', 450000),
  ('BLR', 'LMS-BLR', 'MBA', 'Accenture', 'Digital Business Transformation', '2025-01-10', 'Business transformation sprint', 460000),
...
insert into tmp_demo_grant_rows_extra values
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Capgemini', 'Enterprise Transformation and ESG Strategy', '2023-11-17', 'Responsible transformation playbook lab', 'Capgemini Foundation', 960000),
  ...
  ('BLR', 'LMS-BLR', 'MBA', 'Accenture', 'Digital Business Transformation', '2025-01-10', 'Digital transformation leadership studio', 'Accenture CSR', 1050000),
